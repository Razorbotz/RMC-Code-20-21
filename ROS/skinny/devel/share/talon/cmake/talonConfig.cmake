...
if("TRUE" STREQUAL "TRUE")
  set(talon_SOURCE_PREFIX /home/team/SoftwareDevelopment/ROS/src/talon)
  set(talon_DEVEL_PREFIX /home/team/SoftwareDevelopment/ROS/devel)
  set(talon_INSTALL_PREFIX "")
  set(talon_PREFIX ${talon_DEVEL_PREFIX})
else()
  set(talon_SOURCE_PREFIX "")
  set(talon_DEVEL_PREFIX "")
  set(talon_INSTALL_PREFIX /home/team/SoftwareDevelopment/ROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'talon' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/team/SoftwareDevelopment/ROS/src/talon/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT talon_NUM_DUMMY_TARGETS)
      set(talon_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::talon::wrapped-linker-option${talon_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR talon_NUM_DUMMY_TARGETS "${talon_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::talon::wrapped-linker-option${talon_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND talon_LIBRARIES "${interface_target_name}")
