...
(defsystem "messages-msg"
  ...
  :components ((:file "_package")
    (:file "AxisState" :depends-on ("_package_AxisState"))
    (:file "_package_AxisState" :depends-on ("_package"))
    ...
    (:file "KeyState" :depends-on ("_package_KeyState"))
    (:file "_package_KeyState" :depends-on ("_package"))
