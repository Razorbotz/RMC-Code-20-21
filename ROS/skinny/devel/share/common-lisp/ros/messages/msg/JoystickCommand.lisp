...
(cl:defmethod cl:initialize-instance :after ((m <JoystickCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JoystickCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-msg:<JoystickCommand> is deprecated: use messages-msg:JoystickCommand instead.")))

(cl:ensure-generic-function 'axisX-val :lambda-list '(m))
(cl:defmethod axisX-val ((m <JoystickCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-msg:axisX-val is deprecated.  Use messages-msg:axisX instead.")
  (axisX m))

(cl:ensure-generic-function 'axisY-val :lambda-list '(m))
(cl:defmethod axisY-val ((m <JoystickCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-msg:axisY-val is deprecated.  Use messages-msg:axisY instead.")
  (axisY m))
