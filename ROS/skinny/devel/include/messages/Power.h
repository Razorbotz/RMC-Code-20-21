// Generated by gencpp from file messages/Power.msg
// DO NOT EDIT!


#ifndef MESSAGES_MESSAGE_POWER_H
#define MESSAGES_MESSAGE_POWER_H
...
struct Power_
{
  ...
  typedef boost::shared_ptr< ::messages::Power_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::messages::Power_<ContainerAllocator> const> ConstPtr;

}; // struct Power_

typedef ::messages::Power_<std::allocator<void> > Power;

typedef boost::shared_ptr< ::messages::Power > PowerPtr;
typedef boost::shared_ptr< ::messages::Power const> PowerConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::messages::Power_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::messages::Power_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::messages::Power_<ContainerAllocator1> & lhs, const ::messages::Power_<ContainerAllocator2> & rhs)
{
  return lhs.voltage == rhs.voltage &&
    lhs.current0 == rhs.current0 &&
    lhs.current1 == rhs.current1 &&
    lhs.current2 == rhs.current2 &&
    lhs.current3 == rhs.current3 &&
    lhs.current4 == rhs.current4 &&
    lhs.current5 == rhs.current5 &&
    lhs.current6 == rhs.current6 &&
    lhs.current7 == rhs.current7 &&
    lhs.current8 == rhs.current8 &&
    lhs.current9 == rhs.current9 &&
    lhs.current10 == rhs.current10 &&
    lhs.current11 == rhs.current11 &&
    lhs.current12 == rhs.current12 &&
    lhs.current13 == rhs.current13 &&
    lhs.current14 == rhs.current14 &&
    lhs.current15 == rhs.current15;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::messages::Power_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::messages::Power_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::messages::Power_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::messages::Power_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::messages::Power_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::messages::Power_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::messages::Power_<ContainerAllocator> >
{
  ...
  static const char* value(const ::messages::Power_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa5bf87df7460476eULL;
  static const uint64_t static_value2 = 0x356f8a0cdbf06096ULL;
};

template<class ContainerAllocator>
struct DataType< ::messages::Power_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::messages::Power_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::messages::Power_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::messages::Power_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::messages::Power_<ContainerAllocator>& v)
  {
    s << indent << "voltage: ";
...
#endif // MESSAGES_MESSAGE_POWER_H
