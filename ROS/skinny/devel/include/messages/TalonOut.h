...
bool operator==(const ::messages::TalonOut_<ContainerAllocator1> & lhs, const ::messages::TalonOut_<ContainerAllocator2> & rhs)
{
  return lhs.deviceID == rhs.deviceID &&
    lhs.busVoltage == rhs.busVoltage &&
    lhs.outputCurrent == rhs.outputCurrent &&
    lhs.outputVoltage == rhs.outputVoltage &&
    lhs.outputPercent == rhs.outputPercent &&
    lhs.temperature == rhs.temperature &&
    lhs.sensorPosition == rhs.sensorPosition &&
    lhs.sensorVelocity == rhs.sensorVelocity &&
    lhs.closedLoopError == rhs.closedLoopError &&
    lhs.integralAccumulator == rhs.integralAccumulator &&
    lhs.errorDerivative == rhs.errorDerivative;
}
