...
class JoystickCommand(metaclass=Metaclass_JoystickCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.element = kwargs.get('element', int())
    ...
    def number(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'number' field must be an integer in [-128, 127]"
        self._number = value
    ...
    def element(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'element' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'element' field must be an integer in [-128, 127]"
        self._element = value
