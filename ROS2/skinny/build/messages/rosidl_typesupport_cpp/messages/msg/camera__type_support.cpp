...
static const _Camera_type_support_symbol_names_t _Camera_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, Camera)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages, msg, Camera)),
  }
};
...
{
  return &::messages::msg::rosidl_typesupport_cpp::Camera_message_type_support_handle;
}
