...
static const _KeyState_type_support_symbol_names_t _KeyState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, KeyState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages, msg, KeyState)),
  }
};
...
{
  return &::messages::msg::rosidl_typesupport_cpp::KeyState_message_type_support_handle;
}
